...
def main():
    ...
    model = PPO.load("/home/ksschkw/Projects/fyp/ns-3-dev/contrib/ns3-gym/examples/rl-tcp/ppo_rl_tcp_model_v3")
    print("V3 Model loaded. Running evaluation...")
    ...
    if not xml_file:
        print("No FlowMonitor file found."); return
    rl = parse_flowmon(xml_file)
    if not rl:
        print("Could not parse flow."); return

    print("\nRL Agent (v3) performance:")
    ...
    plt.title('M3.6 v3: RL Agent vs CUBIC Throughput')
    out_path = "/home/ksschkw/Projects/fyp/docu/m3-single-agent-rl/results/m3_comparison_v3.png"
