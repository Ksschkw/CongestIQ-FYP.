#!/usr/bin/env python3
"""Evaluate the retrained model and compare with M2 CUBIC."""
...
def main():
    ...
    model_path = "/home/ksschkw/Projects/fyp/ns-3-dev/contrib/ns3-gym/examples/rl-tcp/ppo_rl_tcp_model_v2"
    ...
    plt.title('M3.6 v2: RL Agent vs CUBIC Throughput')
    out_path = "/home/ksschkw/Projects/fyp/docu/m3-single-agent-rl/results/m3_comparison_v2.png"
