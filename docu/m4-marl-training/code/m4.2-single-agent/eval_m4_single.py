"""Evaluate M4 single-agent model against CUBIC from M2."""
...
def main():
    ...
    model = PPO.load("/home/ksschkw/Projects/fyp/ns-3-dev/contrib/ns3-gym/examples/marl-tcp/ppo_m4_single")
    print("M4 single-agent model loaded. Running evaluation...")
    ...
    print("\nRL Agent (M4 single) performance:")
    ...
    # Chart
    labels = ['RL Agent (M4)', 'CUBIC (M2)']
    throughputs = [rl['throughput_kbps'], cubic_thr]
    plt.bar(labels, throughputs, color=['green','orange'])
    plt.ylabel('Throughput (kbps)')
    plt.title('M4 Single-Agent vs CUBIC Throughput')
    out_path = "/home/ksschkw/Projects/fyp/docu/m4-marl-training/results/m4_single_comparison.png"
